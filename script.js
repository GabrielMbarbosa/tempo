const targetDate=new Date("2024-12-31T23:59:59").getTime(),countdownElement=document.getElementById("countdown");function isMobile(){return 600>=window.innerWidth}function updateCountdown(){const a=new Date().getTime(),b=targetDate-a,c=Math.floor(b/86400000),d=Math.floor(b%86400000/3600000),e=Math.floor(b%3600000/60000),f=Math.floor(b%60000/1e3);countdownElement.innerHTML=isMobile()?`
    ...
    <span class="count-text">Para 2024  <span class="year"> Acabar!</span></span>  `:`
  ...
  `,0>b&&(clearInterval(interval),countdownElement.innerHTML="Feliz Ano Novo!")}const interval=setInterval(updateCountdown,1e3);updateCountdown();